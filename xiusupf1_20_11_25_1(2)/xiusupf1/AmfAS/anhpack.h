...
struct 						hpack_table * hpack_table_new( size_t);
void	 					hpack_table_free( struct hpack_table *);
size_t	 					hpack_table_size( struct hpack_table *);

struct hpack_headerblock * 	hpack_decode( unsigned char * , size_t, struct hpack_table * );
unsigned char * 			hpack_encode( struct hpack_headerblock *, size_t *, struct hpack_table *);

struct hpack_header * 		hpack_header_new( void);
struct hpack_header * 		hpack_header_add( struct hpack_headerblock *, const char *, const char *, enum hpack_header_index);
...
unsigned char *				hpack_huffman_decode( unsigned char *, size_t, size_t *);
char * 						hpack_huffman_decode_str( unsigned char *, size_t);
unsigned char *				hpack_huffman_encode( unsigned char *, size_t, size_t *);
