...
void successful_task_request(  const char *method,int msgtype)
{
    if(manager_metrics)
    {
        //printf("data=%d",data);
        switch(msgtype)
        {
            case 1: //printf("entered successful_task_request\n");
                    prom_counter_inc(manager_metrics->metrics_est_request,0);
                    //prom_counter_add(manager_metrics->metrics_est_request,(double )c,0);
                    break;
            case 2:prom_counter_inc(manager_metrics->metrics_mod_request,0);
                    break;  
            case 3:prom_counter_inc(manager_metrics->metrics_report_request,0);
                    break;   
            case 4:prom_counter_inc(manager_metrics->metrics_delete_request,0);
                    break;  
...
void successful_task_responce(  const char *method,int msgtype)
{
    if(manager_metrics)
    {
        switch(msgtype)
        {
            case 1:prom_counter_inc(manager_metrics->metrics_est_responce,0);
                    break;
            case 2:prom_counter_inc(manager_metrics->metrics_mod_responce,0);
                    break;  
            case 3:prom_counter_inc(manager_metrics->metrics_report_responce,0);
                    break;   
            case 4:prom_counter_inc(manager_metrics->metrics_delete_responce,0);
                    break;  
            default:printf("invalid insert=%s %d\n",__FILE__,__LINE__);
                    break;          
        }
...
void packets_proccesed_promo(  const char *method,int data,int count)
{
    if(manager_metrics)
    {
        ...
        switch(data)
        {
            case 1: prom_counter_add(manager_metrics->metrics_gtp_recvied,(double )count,0);
                    break;
            case 2:prom_counter_add(manager_metrics->metrics_gtp_allowed,(double )count,0);
                    break;  
            case 3:prom_counter_add( manager_metrics->metrics_gtp_dropped,(double )count,0);
                    break;   
            case 4:prom_counter_add( manager_metrics->metrics_gi_recvied,(double )count,0);
                    break;  
            case 5:prom_counter_add( manager_metrics->metrics_gi_allowed,(double )count,0);
                    break; 
            case 6:prom_counter_add( manager_metrics->metrics_gi_dropped,(double )count,0);
                    break;   
            default:printf("invalid insert=%s %d\n",__FILE__,__LINE__);
                    break;     
        }
